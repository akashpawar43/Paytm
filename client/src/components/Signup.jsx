                ...
                <div className=' flex items-center flex-col'>
                    ...
                    <form action="" className=' flex flex-col w-full gap-4 py-5'>
                        <div className=' flex flex-col gap-1.5'>
                            ...
                            <input type="text" placeholder='John' className=' py-1.5 px-2 rounded-md' required />
                        </div>
                        <div className=' flex flex-col gap-1.5'>
                            <label htmlFor="">Last Name</label>
                            <input type="text" placeholder='Doe' className=' py-1.5 px-2 rounded-md' required />
                        </div>
                        <div className=' flex flex-col gap-1.5'>
                        ...
                        <button className=' w-full rounded-md bg-indigo-500 px-2 py-1.5' >Sign Up</button>
                    </form>
                    <p>
